...
# ═══════════════════════════════════════════════════════════
# Runner retry constants
# ═══════════════════════════════════════════════════════════
RUNNER_RETRY_ATTEMPTS = 3
"""Количество попыток получения истории чатов / списка заказов."""
RUNNER_RETRY_DELAY = 1.0
"""Задержка (сек) между повторными попытками в Runner."""
