...
# ═══════════════════════════════════════════════════════════
RETRY_TOTAL = 6
"""Максимальное количество повторных попыток (urllib3 Retry)."""
RETRY_BACKOFF_FACTOR = 1
"""Множитель задержки между повторами: 0s, 1s, 2s, 4s, 8s, 16s."""
RETRY_STATUS_FORCELIST = (429, 500, 502, 503, 504)
"""HTTP коды, при которых urllib3 делает повторный запрос."""
RETRY_429_SLEEP = 0.4
"""Задержка (сек) при HTTP 429 в method() before retry."""
